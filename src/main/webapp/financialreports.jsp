						...
						<div id="accordion">
							<div class="card">
								<div class="card-header">
									<span class="mr-auto">Financial Summary</span> <a
									...
									<div class="card-body">
										<div class="card-body">
											<form id="topupDetails">
												<div class="row">
													...
													<div class="col-md-4">
														<div id="formcurrentBalance_topup"
															...
															<label class="bmd-label-floating select-label">Year<sup
																class="imp">*</sup></label> <select
																class="yrselectdesc form-control start_date"
																id="start_date">
												...
												<div class="row">
													<div class="col-md-11">
														<button type="button" id="financialReport"
